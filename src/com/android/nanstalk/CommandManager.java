...
public class CommandManager {
	...
	private void initCmdList() {
		...
		// ex. 서울대입구 검색
		commonCmd.add(new Command(Cid.KIMGISA_NAVIGATE,		"안내",		EnumSet.of(Copt.POSTFIX, Copt.WITHCONTENT)));
		commonCmd.add(new Command(Cid.KAKAO_SEND,			"전송",		EnumSet.of(Copt.POSTFIX, Copt.WITHCONTENT)));
		
		// ex. 계속
		commonCmd.add(new Command(Cid.KAKAO_FRIEND_LIST,	"목록",		EnumSet.of(Copt.PREFIX)));
		commonCmd.add(new Command(Cid.KAKAO_CHAT_LIST,		"대화",		EnumSet.of(Copt.PREFIX)));
		
		commonCmd.add(new Command(Cid.KIMGISA_YES,			"예",		EnumSet.of(Copt.PREFIX)));
		commonCmd.add(new Command(Cid.KIMGISA_NO,			"아니오",	EnumSet.of(Copt.PREFIX)));
		commonCmd.add(new Command(Cid.KIMGISA_CONTINUE,		"계속",		EnumSet.of(Copt.PREFIX)));
		commonCmd.add(new Command(Cid.KIMGISA_LOCATION,		"장소",		EnumSet.of(Copt.PREFIX)));
		commonCmd.add(new Command(Cid.KIMGISA_MAP,			"지도",		EnumSet.of(Copt.PREFIX)));
		commonCmd.add(new Command(Cid.KIMGISA_NAVEND,		"안내종료",	EnumSet.of(Copt.PREFIX)));
		
		commonCmd.add(new Command(Cid.KMP_START,			"시작",		EnumSet.of(Copt.PREFIX)));
		commonCmd.add(new Command(Cid.KMP_STOP,				"정지",		EnumSet.of(Copt.PREFIX)));
		commonCmd.add(new Command(Cid.KMP_PLAY,				"재생",		EnumSet.of(Copt.PREFIX)));
		...
		// ex. 김강욱 검색
		commonCmd.add(new Command(Cid.KAKAO_SEARCH,			"검색",		EnumSet.of(Copt.POSTFIX, Copt.WITHCONTACT)));
	}
    ...
    public String getCommandString(CommandContent cmdContent) {
    	...
    	if(!appName.equals("")) {
    		...
    		if(cid == Cid.KAKAO_SEARCH || cid == Cid.KAKAO_SEND)
    ...
    private String cidToString(Cid cid) {
    	...
    	case KIMGISA_NAVIGATE: 		return "안내";
    	case KAKAO_SEARCH: 		return "검색";
    	case KAKAO_SEND: 			return "전송";
    	case KAKAO_FRIEND_LIST: 	return "목록";
    	case KAKAO_CHAT_LIST: 	return "대화";
    	case KIMGISA_CONTINUE: 		return "계속";
    	case KIMGISA_LOCATION: 		return "장소";
    	case KIMGISA_MAP: 			return "지도";
    	case KIMGISA_NAVEND: 		return "안내종료";
    	case KMP_START: 		return "시작";
    	case KMP_STOP: 			return "정지";
    	case KMP_PLAY: 			return "재생";
	...
	private String getPackageNameByAppName(String appName) {
		String packageName = "";
	    if (appName.equals("카카오톡"))
	    	packageName = "com.kakao.talk";
	    //hschoi
	    else if (appName.equals("메신저"))
	    	packageName = "com.facebook.orca";
	    else if (appName.equals("김기사"))
	    	packageName = "com.locnall.KimGiSa";
	    else if (appName.equals("영화"))
